    ...
    <div className="flex min-h-screen items-center justify-center bg-gta-bg">
      <div className="w-full max-w-sm mx-4">
        ...
        <a
          ...
          className="gta-card flex items-center justify-center gap-3 w-full cursor-pointer hover:bg-[#5865F2]/10 transition-colors mb-4"
        >
          ...
          <span className="text-sm font-medium text-white">Se connecter avec Discord</span>
        </a>

        <div className="relative my-6">
          <div className="absolute inset-0 flex items-center">
            <div className="w-full border-t border-gta-border" />
          </div>
          <div className="relative flex justify-center text-sm">
            <span className="bg-gta-bg px-3 text-gta-text-dim">ou</span>
          </div>
        </div>
